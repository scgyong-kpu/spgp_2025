...
public class MainScene extends Scene {
    public enum Layer {
        bg, floor, item, player, ui, controller;
    ...
    public MainScene() {
        ...
        add(Layer.ui, new Sprite(R.mipmap.btn_slide_n, 150f, 800f, 200f, 75f ));
        add(Layer.ui, new Sprite(R.mipmap.btn_jump_n, 1450f, 770f, 200f, 75f ));
        add(Layer.ui, new Sprite(R.mipmap.btn_fall_n, 1450f, 850f, 200f, 75f ));
